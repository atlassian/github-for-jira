...
export const logicalOrHelper = (...args: unknown[]) => args.filter((arg: unknown) => typeof arg !== "object").some(Boolean);
export const logicalAndHelper = (...args: unknown[]) => args.filter((arg: unknown) => typeof arg !== "object").every(Boolean);

export const registerHandlebarsHelpers = () => {
	hbs.registerHelper("toLowerCase", toLowercaseHelper);
	hbs.registerHelper("or", logicalOrHelper);
	hbs.registerHelper("and", logicalAndHelper);
