...
envCheck(
	...
	"SQS_JIRA_WEBHOOKS_QUEUE_URL",
	"SQS_JIRA_WEBHOOKS_QUEUE_REGION",
	"SQS_GITHUB_WEBHOOKS_QUEUE_URL",
	"SQS_GITHUB_WEBHOOKS_QUEUE_REGION",
	"MICROS_AWS_REGION",
	"GLOBAL_HASH_SECRET",
	"CRYPTOR_URL",
...
export interface EnvVars {
	...
	SQS_JIRA_WEBHOOKS_QUEUE_URL: string;
	SQS_JIRA_WEBHOOKS_QUEUE_REGION: string;
	SQS_GITHUB_WEBHOOKS_QUEUE_URL: string;
	SQS_GITHUB_WEBHOOKS_QUEUE_REGION: string;
