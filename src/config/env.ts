...
envCheck(
	...
	"DYNAMO_DEPLOYMENT_HISTORY_TABLE_REGION",
	"DYNAMO_DEPLOYMENT_HISTORY_TABLE_NAME",
	"MICROS_AWS_REGION",
	"GLOBAL_HASH_SECRET",
	"CRYPTOR_URL",
...
export interface EnvVars {
	...
	DYNAMO_DEPLOYMENT_HISTORY_TABLE_REGION: string;
	DYNAMO_DEPLOYMENT_HISTORY_TABLE_NAME: string;
