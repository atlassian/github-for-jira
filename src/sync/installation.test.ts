...
describe("sync/installation", () => {
	...
	const TASK: Task = { task: "commit", repositoryId: 123, repository: TEST_REPO, taskStartTimeInSec: new Date().getTime() };
	...
	describe("handleBackfillError", () => {
		...
		it("don't reschedule a repository sync straight after a failed repository", async () => {
			...
			const MOCK_REPO_TASK: Task = { task: "repository", repositoryId: 0, repository: TEST_REPO, taskStartTimeInSec: new Date().getTime() };
