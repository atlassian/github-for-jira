...
export const getCommitTask = async (logger: LoggerWithTarget, _github: GitHubAPI, gitHubClient: GitHubAppClient, _jiraHost: string, repository: Repository, cursor?: string | number, perPage?: number): Promise<CommitData> => {
