import { transformPullRequestOld } from "../transforms/transform-pull-request";
...
export const 	pullRequestWebhookHandler = async (context: WebhookContext, jiraClient, util, gitHubInstallationId: number, subscription: Subscription): Promise<void> => {
	...
	const jiraPayload: JiraPullRequestBulkSubmitData | undefined = await transformPullRequestOld(gitHubInstallationClient, pull_request, reviews, context.log);
