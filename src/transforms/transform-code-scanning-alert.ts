...
export const transformCodeScanningAlert = async (context: Context, githubInstallationId: number): Promise<JiraRemoteLinkData | undefined> => {
	...
	const githubClient = await booleanFlag(BooleanFlags.USE_NEW_GITHUB_CLIENT_FOR_PR_TITLE, false) ?
