...
const config = require('../../db/config.json')[process.env.NODE_ENV || 'development'];

config.benchmark = true;
config.logging = config.disable_sql_logging ? undefined : (query, ms) => logger.debug({ms}, query);
