...
describe("jwt", () => {
	...
	const testQsh =
		"345c5da1c34c5126155b18ff4522446c89cc017debe4878bfa6056cacd5245ae";
	...
	describe("#verifyAsymmetricJwtTokenMiddleware", () => {
		beforeEach(async () => {
			when(queryAtlassianConnectPublicKey)
				.calledWith(testKid)
		...
		const buildRequestWithJwtPayload = (jwtPayload: any, key?: string): any => {
			...
			const jwtValue = encodeAsymmetric(
				jwtPayload,
				key,
