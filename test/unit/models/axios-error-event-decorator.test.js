...
describe(AxiosErrorDecorator, () => {
  ...
  describe('GET 403', () => {
    ...
    beforeEach(async () => {
      ...
      const error = await axios.get('https://www.example.com/foo/bar').catch((err) => Promise.resolve(err));
      event = buildEvent();
  ...
  describe('GET 403', () => {
    ...
    beforeEach(async () => {
      ...
      const error = await axios.get('https://www.example.com/foo/bar', { params: { hi: 'hello' } }).catch((err) => Promise.resolve(err));
  ...
  describe('POST with JSON body', () => {
    ...
    beforeEach(async () => {
      ...
      const error = await axios.post('https://www.example.com/foo/bar', { hello: 'hi' }).catch((err) => Promise.resolve(err));
  ...
  describe('POST with form body', () => {
    ...
    beforeEach(async () => {
      ...
      const error = await axios.post('https://www.example.com/foo/bar', 'hi=hello').catch((err) => Promise.resolve(err));
