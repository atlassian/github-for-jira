...
module.exports = {
  up: async (queryInterface) => {
    ...
    create or replace view analytics.subscriptions(id, github_installation_id, jira_host, created_at, updated_at, repo_sync_state, selected_repositories, sync_status, sync_warning, number_synced_repos, hours_since_created_at, hours_since_updated_at) as
