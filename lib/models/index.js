...
if (config.use_env_variable) {
  logger.info(`initializing Sequelize: NODE_ENV=${process.env.NODE_ENV}, env var name=${config.use_env_variable}, env var value=${process.env[config.use_env_variable].substr(0, 20)}***}`);
