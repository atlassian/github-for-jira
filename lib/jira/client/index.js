 ...
 * interoperability.
 */
async function getJiraClient(jiraHost, gitHubInstallationId) {
      ...
      migration: {
        complete: async () => {
          ...
          try {
            ...
            logger.error(`migrationComplete error: ${err}`);
          }
        },
        undo: async () => {
          /**
          ...
          try {
            ...
            logger.error(`undoMigration error: ${err}`);
          }
        },
      },
      pullRequest: {
      ...
      repository: {
        ...
        update: async (data, options) => {
          ...
          try {
            ...
            logger.error(`batchedBulkUpdate error: ${err}`);
          }
        },
      },
    },
