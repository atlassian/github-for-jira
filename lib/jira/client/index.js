...
module.exports = async (id, installationId, jiraHost) => {
  ...
  const client = {
    ...
    devinfo: {
      ...
      branch: {
        exists: (branchRef) => instance.get(`/rest/devinfo/0.10/existsByProperties?branchId=${branchRef}`),
        delete: (repositoryId, branchRef) => instance.delete(`/rest/devinfo/0.10/repository/${repositoryId}/branch/${branchRef}`, {
