...
module.exports = async (id, installationId, jiraHost) => {
  ...
  const client = {
    ...
    devinfo: {
      ...
      repository: {
        delete: (repositoryId) => instance.delete('/rest/devinfo/0.10/bulkByProperties', {
          fields: { repositoryId }
        }),
        deleteAll: (_updateSequenceId) => instance.delete('/rest/devinfo/0.10/bulkByProperties', {
          fields: { _updateSequenceId, baseURL }
        }),
