...
function getFrontendApp (appTokenGenerator) {
  ...
  app.get('/github/configuration', githubClientMiddleware, getGitHubConfiguration)
  app.post('/github/configuration', postGitHubConfiguration)

  app.get('/jira/configuration', verifyJiraMiddleware, githubClientMiddleware, getJiraConfiguration)
