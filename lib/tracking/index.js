...
async function submitProto(protos) {
  ...
  // This assumes that the protos are homogenous, maybe something to consider later
  statsd.increment(submissionMetricName, protos.length, [`schema:${protos[0].schema}`, `status:${status}`]);
