...
test("Connect GitHub Screen - Checking the GitHub Cloud flow when authenticated with orgs with errors", async () => {
	...
	expect(errorForNonAdmins[0].textContent).toBe("Can't connect, you're not the organization owner.Ask an organization owner to complete this step or send a link to them by clicking here.");
