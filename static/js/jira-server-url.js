...
AJS.formValidation.register(['ghe-url'], (field) => {
	...
	try {
		...
		if (!/^https?:$/.test(protocol)) {
			...
			field.invalidate(AJS.format('The entered URL is a GitHub Cloud site. <a href="/session/cloud/github/configuration" target="_blank">Connect a GitHub Cloud site<a/>.'));
		} else {
			field.validate();
		}
	} catch (e) {
